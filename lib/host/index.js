...
export function apply(ctx, config) {
    ...
    ctx.inject(['tools'], (toolsCtx) => {
        ...
        toolsCtx.tools.register({
            ...
            description: 'Cancella o resetta il piano operativo attuale. Utile quando l\'utente vuole interrompere il piano o ripartire da zero.',
            parameters: {
            ...
            execute: async (args) => {
                ...
                return { success: true, message: 'Piano operativo cancellato con successo. La dashboard è stata resettata.' };
            }
        });
    });
}
