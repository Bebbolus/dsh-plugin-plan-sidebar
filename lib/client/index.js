...
import { ToolDetailEmitter } from "./tabs/tools/events.js";
...
import { createSkillsTabDef } from "./tabs/skills/tab-def.js";
import { createToolsTabDef } from "./tabs/tools/tab-def.js";
import { registerBetterSidebarCard, NS as CARD_PLUGINS_NS } from "./settings-card/register.js";
import { en as cardPluginsEn, zh as cardPluginsZh } from "./settings-card/locales.js";
...
import { en as skillsEn, NS as SKILLS_NS, zh as skillsZh } from "./tabs/skills/locales.js";
import { en as toolsEn, NS as TOOLS_NS, zh as toolsZh } from "./tabs/tools/locales.js";
...
export function apply(ctx) {
    ...
    ctx.effect(() => {
        ...
        // Emitter for the tools tab's double-click detail opens. Named toolsDetail
        // (not `tools`) so it never clashes with the tools tab name in the effect.
        ...
        const disposeSkillsLocale = ctx.locale.register(SKILLS_NS, { zh: skillsZh, en: skillsEn });
        const disposeToolsLocale = ctx.locale.register(TOOLS_NS, { zh: toolsZh, en: toolsEn });
        ...
        const DockEntry = createDockEntry({
            ...
            tools: toolsDetail,
            settings: scope,
            t: ctx.locale.bind(DOCK_NS),
            toolsT: ctx.locale.bind(TOOLS_NS),
            layout: ctx.layout,
        });
