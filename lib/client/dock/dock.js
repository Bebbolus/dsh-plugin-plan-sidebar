...
import { ToolModalEditor } from "../editor/ToolModalEditor.js";
...
export function DockRoot({ useSessions, useWorkspaces, rpc, tabs, events, tools, settings, t, toolsT, layout }) {
...
export function createDockEntry(services) {
    const DockEntry = (props) => (_jsx(DockRoot, { useSessions: props.useSessions, useWorkspaces: props.useWorkspaces, rpc: services.rpc, tabs: services.tabs, events: services.events, tools: services.tools, settings: services.settings, t: services.t, toolsT: services.toolsT, layout: services.layout }));
    return DockEntry;
}
