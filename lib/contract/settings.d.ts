 ...
 * cadence, the git tab's per-command timeout, and the file "View file"
 * dialog's default width. The id and defaults live in
...
export interface BetterSidebarSettings {
    ...
    /** Skills-tab fallback poll cadence in ms. */
    skillsPollMs: number;
    /** Default width in px of the file "View file" dialog. */
    viewFileWidth: number;
}
